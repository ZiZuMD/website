...
if (isset($_POST["submit"])) {
    // Retrieve project name from the form input
    $projectName = $_POST["name"];

    // SQL query to insert the project into the table
...
<div class="page-wrapper">
  ...
  <ul class="main-navigation__list">
    ...
    // Retrieve and display project names from the database
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<a class="main-navigation__list-item-link" href="#">' . $row["project_name"] . '</a>';
            echo '</li>';
        }
    } else {
        echo '<li class="main-navigation__list-item">No projects found.</li>';
    }
    ...
    <div class="form__row">
        <label for="project_name" class="form__label">Введите название проекта:</label>
